...
$dsn = 'mysql:dbname=practica7;host=localhost';//contiene el servicio, nombre de la base de datos y de el host
$user = 'root';//usuario con el que se accesa a la base de datos
$password = '123456';//contraseña para el servicio de la base de datos (Cambiar por la contraseña del servicio mysql local)
