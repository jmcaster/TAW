<!--Archivo con el formulario para actualizar datos de un futbolista-->
<?php 
	...
	$res = $pdo->query($sql);//Se ejecuta la sentencia sql
...
<body>
	<?php include 'header.php'; ?>
  	...
  	<div class="large-3 columns" style="width:100%; text-align: center;">
	    ...
	    <form action="update_fut.php"  method="POST" style="width:25%; margin:0 auto;">
	    	<input type="hidden" name="id" value="<?php echo $id;?>" >
	    	<label >Nombre:</label>
	    	<input name="nombre" type="text" style="text-align: center;" value="<?php echo $row['nombre'];?>" required>
	    	<br>
	    	<label >Posicion:</label>
	    	<input name="posicion" type="text" style="text-align: center;" value="<?php echo $row['posicion'];?>" required>
	    	<br>
	    	<label>Equipo</label>
	    	<select name="equipo">
