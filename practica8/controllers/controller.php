...
class MvcController{
	...
	public function vistaUsuariosController(){
		...
		echo'<tr>
				...
				<td>'.$item["carrera"].'</td>
				<td>'.$item["email"].'</td>
				<td><a href="index.php?action=editar&id='.$item["num_empleado"].'"><button>Editar</button></a></td>
				<td><a href="index.php?action=usuarios&idBorrar='.$item["num_empleado"].'"><button>Borrar</button></a></td>
			</tr>';
